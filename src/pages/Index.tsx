...
import aiTutorInterface from '@/assets/ai-tutor-interface.png';
const Index = () => {
  useScrollAnimation();
  useEffect(() => {
          ...
          <div className="container mx-auto px-4 bg-zinc-900">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              animationDelay: '0.15s'
                ...
                <div className="rounded-2xl overflow-hidden shadow-2xl border border-primary/20 hover:border-primary/60 transition-all duration-500 hover:scale-105 hover:shadow-primary/20">
                  <img src={aiTutorInterface} alt="AI-Powered Legal Tutor - Get instant answers to legal questions" className="w-full h-auto" />
                </div>
                <div className="mt-6">
